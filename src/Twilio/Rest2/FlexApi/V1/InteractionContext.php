...
use Twilio\Rest2\FlexApi\V1\Interaction\InteractionChannelList;


/**
 * @property InteractionChannelList $channels
 * @method \Twilio\Rest2\FlexApi\V1\Interaction\InteractionChannelContext channels(string $sid)
 */
