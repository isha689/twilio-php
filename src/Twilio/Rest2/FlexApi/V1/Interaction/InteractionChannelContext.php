...
namespace Twilio\Rest2\FlexApi\V1\Interaction;
...
use Twilio\Rest2\FlexApi\V1\Interaction\InteractionChannel\InteractionChannelParticipantList;
use Twilio\Rest2\FlexApi\V1\Interaction\InteractionChannel\InteractionChannelInviteList;


/**
 * @property InteractionChannelParticipantList $participants
 * @property InteractionChannelInviteList $invites
 * @method \Twilio\Rest2\FlexApi\V1\Interaction\InteractionChannel\InteractionChannelParticipantContext participants(string $sid)
 */
