...
namespace Twilio\Rest2\Proxy\V1;
...
use Twilio\Rest2\Proxy\V1\Service\PhoneNumberList;
use Twilio\Rest2\Proxy\V1\Service\ShortCodeList;
use Twilio\Rest2\Proxy\V1\Service\SessionList;
 ...
 * @method \Twilio\Rest2\Proxy\V1\Service\SessionContext sessions(string $sid)
 * @method \Twilio\Rest2\Proxy\V1\Service\ShortCodeContext shortCodes(string $sid)
 * @method \Twilio\Rest2\Proxy\V1\Service\PhoneNumberContext phoneNumbers(string $sid)
 */
