...
namespace Twilio\Rest2\Proxy\V1\Service;
...
use Twilio\Rest2\Proxy\V1\Service\Session\ParticipantList;
use Twilio\Rest2\Proxy\V1\Service\Session\InteractionList;


/**
 * @property ParticipantList $participants
 * @property InteractionList $interactions
 * @method \Twilio\Rest2\Proxy\V1\Service\Session\InteractionContext interactions(string $sid)
 * @method \Twilio\Rest2\Proxy\V1\Service\Session\ParticipantContext participants(string $sid)
 */
