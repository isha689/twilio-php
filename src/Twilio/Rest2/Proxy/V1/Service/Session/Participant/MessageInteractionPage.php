...
namespace Twilio\Rest2\Proxy\V1\Service\Session\Participant;
...
class MessageInteractionPage extends Page {
     ...
     * @return MessageInteractionInstance \Twilio\Rest2\Proxy\V1\Service\Session\Participant\MessageInteractionInstance
     */
