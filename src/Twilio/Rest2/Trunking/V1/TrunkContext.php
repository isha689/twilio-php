...
namespace Twilio\Rest2\Trunking\V1;
...
use Twilio\Rest2\Trunking\V1\Trunk\IpAccessControlListList;
use Twilio\Rest2\Trunking\V1\Trunk\PhoneNumberList;
use Twilio\Rest2\Trunking\V1\Trunk\CredentialListList;
use Twilio\Rest2\Trunking\V1\Trunk\OriginationUrlList;
use Twilio\Rest2\Trunking\V1\Trunk\RecordingList;
 ...
 * @method \Twilio\Rest2\Trunking\V1\Trunk\RecordingContext recordings()
 * @method \Twilio\Rest2\Trunking\V1\Trunk\CredentialListContext credentialsLists(string $sid)
 * @method \Twilio\Rest2\Trunking\V1\Trunk\IpAccessControlListContext ipAccessControlLists(string $sid)
 * @method \Twilio\Rest2\Trunking\V1\Trunk\PhoneNumberContext phoneNumbers(string $sid)
 * @method \Twilio\Rest2\Trunking\V1\Trunk\OriginationUrlContext originationUrls(string $sid)
 */
