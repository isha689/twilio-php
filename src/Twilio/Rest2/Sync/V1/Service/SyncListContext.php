...
use Twilio\Rest2\Sync\V1\Service\SyncList\SyncListPermissionList;
use Twilio\Rest2\Sync\V1\Service\SyncList\SyncListItemList;


/**
 * @property SyncListPermissionList $syncListPermissions
 * @property SyncListItemList $syncListItems
 * @method \Twilio\Rest2\Sync\V1\Service\SyncList\SyncListPermissionContext syncListPermissions(string $identity)
 * @method \Twilio\Rest2\Sync\V1\Service\SyncList\SyncListItemContext syncListItems(string $index)
 */
