...
use Twilio\Rest2\Sync\V1\Service\Document\DocumentPermissionList;


/**
 * @property DocumentPermissionList $documentPermissions
 * @method \Twilio\Rest2\Sync\V1\Service\Document\DocumentPermissionContext documentPermissions(string $identity)
 */
