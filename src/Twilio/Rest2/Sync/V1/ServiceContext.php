...
namespace Twilio\Rest2\Sync\V1;
...
use Twilio\Rest2\Sync\V1\Service\SyncListList;
use Twilio\Rest2\Sync\V1\Service\SyncStreamList;
use Twilio\Rest2\Sync\V1\Service\DocumentList;
use Twilio\Rest2\Sync\V1\Service\SyncMapList;
 ...
 * @method \Twilio\Rest2\Sync\V1\Service\SyncStreamContext syncStreams(string $sid)
 * @method \Twilio\Rest2\Sync\V1\Service\SyncListContext syncLists(string $sid)
 * @method \Twilio\Rest2\Sync\V1\Service\SyncMapContext syncMaps(string $sid)
 * @method \Twilio\Rest2\Sync\V1\Service\DocumentContext documents(string $sid)
 */
