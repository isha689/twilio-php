...
namespace Twilio\Rest2\Serverless\V1;
...
use Twilio\Rest2\Serverless\V1\Service\FunctionList;
use Twilio\Rest2\Serverless\V1\Service\BuildList;
use Twilio\Rest2\Serverless\V1\Service\EnvironmentList;
use Twilio\Rest2\Serverless\V1\Service\AssetList;
 ...
 * @method \Twilio\Rest2\Serverless\V1\Service\EnvironmentContext environments(string $sid)
 * @method \Twilio\Rest2\Serverless\V1\Service\FunctionContext functions(string $sid)
 * @method \Twilio\Rest2\Serverless\V1\Service\BuildContext builds(string $sid)
 * @method \Twilio\Rest2\Serverless\V1\Service\AssetContext assets(string $sid)
 */
