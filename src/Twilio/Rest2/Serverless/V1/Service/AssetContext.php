...
use Twilio\Rest2\Serverless\V1\Service\Asset\AssetVersionList;


/**
 * @property AssetVersionList $assetVersions
 * @method \Twilio\Rest2\Serverless\V1\Service\Asset\AssetVersionContext assetVersions(string $sid)
 */
