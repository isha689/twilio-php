...
namespace Twilio\Rest2\Autopilot\V1;
...
use Twilio\Rest2\Autopilot\V1\Assistant\FieldTypeList;
use Twilio\Rest2\Autopilot\V1\Assistant\ModelBuildList;
use Twilio\Rest2\Autopilot\V1\Assistant\QueryList;
use Twilio\Rest2\Autopilot\V1\Assistant\WebhookList;
use Twilio\Rest2\Autopilot\V1\Assistant\TaskList;
use Twilio\Rest2\Autopilot\V1\Assistant\DefaultsList;
use Twilio\Rest2\Autopilot\V1\Assistant\StyleSheetList;
use Twilio\Rest2\Autopilot\V1\Assistant\DialogueList;
 ...
 * @method \Twilio\Rest2\Autopilot\V1\Assistant\TaskContext tasks(string $sid)
 * @method \Twilio\Rest2\Autopilot\V1\Assistant\DefaultsContext defaults()
 * @method \Twilio\Rest2\Autopilot\V1\Assistant\WebhookContext webhooks(string $sid)
 * @method \Twilio\Rest2\Autopilot\V1\Assistant\DialogueContext dialogues(string $sid)
 * @method \Twilio\Rest2\Autopilot\V1\Assistant\ModelBuildContext modelBuilds(string $sid)
 * @method \Twilio\Rest2\Autopilot\V1\Assistant\FieldTypeContext fieldTypes(string $sid)
 * @method \Twilio\Rest2\Autopilot\V1\Assistant\StyleSheetContext styleSheet()
 * @method \Twilio\Rest2\Autopilot\V1\Assistant\QueryContext queries(string $sid)
 */
