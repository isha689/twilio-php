...
use Twilio\Rest2\Autopilot\V1\Assistant\FieldType\FieldValueList;


/**
 * @property FieldValueList $fieldValues
 * @method \Twilio\Rest2\Autopilot\V1\Assistant\FieldType\FieldValueContext fieldValues(string $sid)
 */
