...
namespace Twilio\Rest2\Bulkexports\V1;

use Twilio\Exceptions\TwilioException;
use Twilio\ListResource;
use Twilio\Version;
use Twilio\InstanceContext;
use Twilio\Rest2\Bulkexports\V1\Export\ExportCustomJobList;
use Twilio\Rest2\Bulkexports\V1\Export\DayList;


/**
 * @property ExportCustomJobList $exportCustomJobs
 * @property DayList $days
 * @method \Twilio\Rest2\Bulkexports\V1\Export\DayContext days(string $day)
 */
