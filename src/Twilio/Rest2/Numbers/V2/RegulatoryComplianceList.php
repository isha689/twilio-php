...
namespace Twilio\Rest2\Numbers\V2;

use Twilio\Exceptions\TwilioException;
use Twilio\ListResource;
use Twilio\Version;
use Twilio\InstanceContext;
use Twilio\Rest2\Numbers\V2\RegulatoryCompliance\BundleList;
use Twilio\Rest2\Numbers\V2\RegulatoryCompliance\RegulationList;
use Twilio\Rest2\Numbers\V2\RegulatoryCompliance\EndUserTypeList;
use Twilio\Rest2\Numbers\V2\RegulatoryCompliance\EndUserList;
use Twilio\Rest2\Numbers\V2\RegulatoryCompliance\SupportingDocumentTypeList;
use Twilio\Rest2\Numbers\V2\RegulatoryCompliance\SupportingDocumentList;
 ...
 * @method \Twilio\Rest2\Numbers\V2\RegulatoryCompliance\EndUserContext endUsers(string $sid)
 * @method \Twilio\Rest2\Numbers\V2\RegulatoryCompliance\BundleContext bundles(string $sid)
 * @method \Twilio\Rest2\Numbers\V2\RegulatoryCompliance\SupportingDocumentTypeContext supportingDocumentTypes(string $sid)
 * @method \Twilio\Rest2\Numbers\V2\RegulatoryCompliance\RegulationContext regulations(string $sid)
 * @method \Twilio\Rest2\Numbers\V2\RegulatoryCompliance\EndUserTypeContext endUserTypes(string $sid)
 * @method \Twilio\Rest2\Numbers\V2\RegulatoryCompliance\SupportingDocumentContext supportingDocuments(string $sid)
 */
