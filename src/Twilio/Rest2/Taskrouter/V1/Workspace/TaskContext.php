...
use Twilio\Rest2\Taskrouter\V1\Workspace\Task\ReservationList;


/**
 * @property ReservationList $reservations
 * @method \Twilio\Rest2\Taskrouter\V1\Workspace\Task\ReservationContext reservations(string $sid)
 */
