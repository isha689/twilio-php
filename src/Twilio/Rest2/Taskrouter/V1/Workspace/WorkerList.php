...
use Twilio\Rest2\Taskrouter\V1\Workspace\Worker\WorkersStatisticsList;


/**
 * @property WorkersStatisticsList $statistics
 * @method \Twilio\Rest2\Taskrouter\V1\Workspace\Worker\WorkersStatisticsContext statistics()
 */
