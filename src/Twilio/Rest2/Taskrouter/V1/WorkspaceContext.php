...
namespace Twilio\Rest2\Taskrouter\V1;
...
use Twilio\Rest2\Taskrouter\V1\Workspace\TaskQueueList;
use Twilio\Rest2\Taskrouter\V1\Workspace\EventList;
use Twilio\Rest2\Taskrouter\V1\Workspace\TaskChannelList;
use Twilio\Rest2\Taskrouter\V1\Workspace\ActivityList;
use Twilio\Rest2\Taskrouter\V1\Workspace\WorkerList;
use Twilio\Rest2\Taskrouter\V1\Workspace\WorkflowList;
use Twilio\Rest2\Taskrouter\V1\Workspace\TaskList;
use Twilio\Rest2\Taskrouter\V1\Workspace\WorkspaceCumulativeStatisticsList;
use Twilio\Rest2\Taskrouter\V1\Workspace\WorkspaceRealTimeStatisticsList;
use Twilio\Rest2\Taskrouter\V1\Workspace\WorkspaceStatisticsList;
 ...
 * @method \Twilio\Rest2\Taskrouter\V1\Workspace\WorkspaceCumulativeStatisticsContext cumulativeStatistics()
 * @method \Twilio\Rest2\Taskrouter\V1\Workspace\TaskQueueContext taskQueues(string $sid)
 * @method \Twilio\Rest2\Taskrouter\V1\Workspace\ActivityContext activities(string $sid)
 * @method \Twilio\Rest2\Taskrouter\V1\Workspace\WorkspaceRealTimeStatisticsContext realTimeStatistics()
 * @method \Twilio\Rest2\Taskrouter\V1\Workspace\TaskContext tasks(string $sid)
 * @method \Twilio\Rest2\Taskrouter\V1\Workspace\WorkflowContext workflows(string $sid)
 * @method \Twilio\Rest2\Taskrouter\V1\Workspace\EventContext events(string $sid)
 * @method \Twilio\Rest2\Taskrouter\V1\Workspace\WorkerContext workers(string $sid)
 * @method \Twilio\Rest2\Taskrouter\V1\Workspace\WorkspaceStatisticsContext statistics()
 * @method \Twilio\Rest2\Taskrouter\V1\Workspace\TaskChannelContext taskChannels(string $sid)
 */
