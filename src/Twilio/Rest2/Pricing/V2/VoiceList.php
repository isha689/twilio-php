...
namespace Twilio\Rest2\Pricing\V2;

use Twilio\Exceptions\TwilioException;
use Twilio\ListResource;
use Twilio\Version;
use Twilio\InstanceContext;
use Twilio\Rest2\Pricing\V2\Voice\CountryList;
use Twilio\Rest2\Pricing\V2\Voice\NumberList;


/**
 * @property CountryList $countries
 * @property NumberList $numbers
 * @method \Twilio\Rest2\Pricing\V2\Voice\CountryContext countries(string $isoCountry)
 * @method \Twilio\Rest2\Pricing\V2\Voice\NumberContext numbers(string $destinationNumber)
 */
