...
namespace Twilio\Rest2\Video\V1\Room;
...
use Twilio\Rest2\Video\V1\Room\Participant\SubscribeRulesList;
use Twilio\Rest2\Video\V1\Room\Participant\SubscribedTrackList;
use Twilio\Rest2\Video\V1\Room\Participant\PublishedTrackList;
use Twilio\Rest2\Video\V1\Room\Participant\AnonymizeList;
 ...
 * @method \Twilio\Rest2\Video\V1\Room\Participant\SubscribedTrackContext subscribedTracks(string $sid)
 * @method \Twilio\Rest2\Video\V1\Room\Participant\AnonymizeContext anonymize()
 * @method \Twilio\Rest2\Video\V1\Room\Participant\PublishedTrackContext publishedTracks(string $sid)
 */
