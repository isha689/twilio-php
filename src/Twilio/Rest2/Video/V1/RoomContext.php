 ...
 * @method \Twilio\Rest2\Video\V1\Room\ParticipantContext participants(string $sid)
 * @method \Twilio\Rest2\Video\V1\Room\RoomRecordingContext recordings(string $sid)
 */
