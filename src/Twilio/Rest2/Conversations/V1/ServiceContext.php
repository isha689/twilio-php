...
use Twilio\Rest2\Conversations\V1\Service\UserList;
use Twilio\Rest2\Conversations\V1\Service\BindingList;
use Twilio\Rest2\Conversations\V1\Service\ParticipantConversationList;
use Twilio\Rest2\Conversations\V1\Service\ConversationList;
use Twilio\Rest2\Conversations\V1\Service\RoleList;
use Twilio\Rest2\Conversations\V1\Service\ConfigurationList;
 ...
 * @method \Twilio\Rest2\Conversations\V1\Service\UserContext users(string $sid)
 * @method \Twilio\Rest2\Conversations\V1\Service\RoleContext roles(string $sid)
 * @method \Twilio\Rest2\Conversations\V1\Service\ConfigurationContext configuration()
 * @method \Twilio\Rest2\Conversations\V1\Service\BindingContext bindings(string $sid)
 * @method \Twilio\Rest2\Conversations\V1\Service\ConversationContext conversations(string $sid)
 */
