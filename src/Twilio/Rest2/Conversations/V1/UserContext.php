...
use Twilio\Rest2\Conversations\V1\User\UserConversationList;


/**
 * @property UserConversationList $userConversations
 * @method \Twilio\Rest2\Conversations\V1\User\UserConversationContext userConversations(string $conversationSid)
 */
