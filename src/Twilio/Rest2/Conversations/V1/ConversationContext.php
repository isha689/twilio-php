...
use Twilio\Rest2\Conversations\V1\Conversation\ParticipantList;
use Twilio\Rest2\Conversations\V1\Conversation\WebhookList;
use Twilio\Rest2\Conversations\V1\Conversation\MessageList;
 ...
 * @method \Twilio\Rest2\Conversations\V1\Conversation\WebhookContext webhooks(string $sid)
 * @method \Twilio\Rest2\Conversations\V1\Conversation\MessageContext messages(string $sid)
 * @method \Twilio\Rest2\Conversations\V1\Conversation\ParticipantContext participants(string $sid)
 */
