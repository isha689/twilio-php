...
use Twilio\Rest2\Api\V2010\Account\Call\FeedbackSummaryList;


/**
 * @property FeedbackSummaryList $feedbackSummaries
 * @method \Twilio\Rest2\Api\V2010\Account\Call\FeedbackSummaryContext feedbackSummaries(string $sid)
 */
