...
use Twilio\Rest2\Api\V2010\Account\IncomingPhoneNumber\AssignedAddOnList;


/**
 * @property AssignedAddOnList $assignedAddOns
 * @method \Twilio\Rest2\Api\V2010\Account\IncomingPhoneNumber\AssignedAddOnContext assignedAddOns(string $sid)
 */
