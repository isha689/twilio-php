...
use Twilio\Rest2\Api\V2010\Account\Sip\IpAccessControlList\IpAddressList;


/**
 * @property IpAddressList $ipAddresses
 * @method \Twilio\Rest2\Api\V2010\Account\Sip\IpAccessControlList\IpAddressContext ipAddresses(string $sid)
 */
