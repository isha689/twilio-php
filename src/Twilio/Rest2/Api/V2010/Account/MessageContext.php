...
use Twilio\Rest2\Api\V2010\Account\Message\FeedbackList;
use Twilio\Rest2\Api\V2010\Account\Message\MediaList;


/**
 * @property FeedbackList $feedback
 * @property MediaList $media
 * @method \Twilio\Rest2\Api\V2010\Account\Message\MediaContext media(string $sid)
 */
