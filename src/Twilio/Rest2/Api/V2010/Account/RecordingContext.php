...
use Twilio\Rest2\Api\V2010\Account\Recording\AddOnResultList;
use Twilio\Rest2\Api\V2010\Account\Recording\TranscriptionList;


/**
 * @property AddOnResultList $addOnResults
 * @property TranscriptionList $transcriptions
 * @method \Twilio\Rest2\Api\V2010\Account\Recording\AddOnResultContext addOnResults(string $sid)
 * @method \Twilio\Rest2\Api\V2010\Account\Recording\TranscriptionContext transcriptions(string $sid)
 */
