...
use Twilio\Rest2\Api\V2010\Account\Conference\ParticipantList;
use Twilio\Rest2\Api\V2010\Account\Conference\RecordingList;


/**
 * @property ParticipantList $participants
 * @property RecordingList $recordings
 * @method \Twilio\Rest2\Api\V2010\Account\Conference\RecordingContext recordings(string $sid)
 * @method \Twilio\Rest2\Api\V2010\Account\Conference\ParticipantContext participants(string $callSid)
 */
