...
use Twilio\Rest2\Accounts\V1\Credential\AwsList;
use Twilio\Rest2\Accounts\V1\Credential\PublicKeyList;


/**
 * @property AwsList $aws
 * @property PublicKeyList $publicKey
 * @method \Twilio\Rest2\Accounts\V1\Credential\PublicKeyContext publicKey(string $sid)
 * @method \Twilio\Rest2\Accounts\V1\Credential\AwsContext aws(string $sid)
 */
