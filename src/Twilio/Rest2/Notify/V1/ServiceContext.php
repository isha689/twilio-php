...
namespace Twilio\Rest2\Notify\V1;
...
use Twilio\Rest2\Notify\V1\Service\NotificationList;
use Twilio\Rest2\Notify\V1\Service\BindingList;


/**
 * @property NotificationList $notifications
 * @property BindingList $bindings
 * @method \Twilio\Rest2\Notify\V1\Service\BindingContext bindings(string $sid)
 */
