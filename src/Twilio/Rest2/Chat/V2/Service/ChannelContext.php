...
namespace Twilio\Rest2\Chat\V2\Service;
...
use Twilio\Rest2\Chat\V2\Service\Channel\MemberList;
use Twilio\Rest2\Chat\V2\Service\Channel\InviteList;
use Twilio\Rest2\Chat\V2\Service\Channel\WebhookList;
use Twilio\Rest2\Chat\V2\Service\Channel\MessageList;
 ...
 * @method \Twilio\Rest2\Chat\V2\Service\Channel\WebhookContext webhooks(string $sid)
 * @method \Twilio\Rest2\Chat\V2\Service\Channel\MemberContext members(string $sid)
 * @method \Twilio\Rest2\Chat\V2\Service\Channel\MessageContext messages(string $sid)
 * @method \Twilio\Rest2\Chat\V2\Service\Channel\InviteContext invites(string $sid)
 */
