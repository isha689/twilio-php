...
use Twilio\Rest2\Chat\V2\Service\User\UserBindingList;
use Twilio\Rest2\Chat\V2\Service\User\UserChannelList;


/**
 * @property UserBindingList $userBindings
 * @property UserChannelList $userChannels
 * @method \Twilio\Rest2\Chat\V2\Service\User\UserChannelContext userChannels(string $channelSid)
 * @method \Twilio\Rest2\Chat\V2\Service\User\UserBindingContext userBindings(string $sid)
 */
