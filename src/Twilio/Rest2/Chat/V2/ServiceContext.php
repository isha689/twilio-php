...
namespace Twilio\Rest2\Chat\V2;
...
use Twilio\Rest2\Chat\V2\Service\ChannelList;
use Twilio\Rest2\Chat\V2\Service\BindingList;
use Twilio\Rest2\Chat\V2\Service\RoleList;
use Twilio\Rest2\Chat\V2\Service\UserList;
 ...
 * @method \Twilio\Rest2\Chat\V2\Service\BindingContext bindings(string $sid)
 * @method \Twilio\Rest2\Chat\V2\Service\ChannelContext channels(string $sid)
 * @method \Twilio\Rest2\Chat\V2\Service\RoleContext roles(string $sid)
 * @method \Twilio\Rest2\Chat\V2\Service\UserContext users(string $sid)
 */
