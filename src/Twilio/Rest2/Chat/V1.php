...
use Twilio\Rest2\Chat\V1\CredentialList;
use Twilio\Rest2\Chat\V1\ServiceList;
use Twilio\Version;

/**
 * @property CredentialList $credentials
 * @property ServiceList $services
 * @method \Twilio\Rest2\Chat\V1\CredentialContext credentials(string $sid)
 * @method \Twilio\Rest2\Chat\V1\ServiceContext services(string $sid)
 */
