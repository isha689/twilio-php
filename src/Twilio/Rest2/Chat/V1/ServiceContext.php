...
namespace Twilio\Rest2\Chat\V1;
...
use Twilio\Rest2\Chat\V1\Service\ChannelList;
use Twilio\Rest2\Chat\V1\Service\RoleList;
use Twilio\Rest2\Chat\V1\Service\UserList;
 ...
 * @method \Twilio\Rest2\Chat\V1\Service\ChannelContext channels(string $sid)
 * @method \Twilio\Rest2\Chat\V1\Service\RoleContext roles(string $sid)
 * @method \Twilio\Rest2\Chat\V1\Service\UserContext users(string $sid)
 */
