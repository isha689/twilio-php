...
use Twilio\Rest2\Chat\V1\Service\Channel\MemberList;
use Twilio\Rest2\Chat\V1\Service\Channel\InviteList;
use Twilio\Rest2\Chat\V1\Service\Channel\MessageList;
 ...
 * @method \Twilio\Rest2\Chat\V1\Service\Channel\MemberContext members(string $sid)
 * @method \Twilio\Rest2\Chat\V1\Service\Channel\MessageContext messages(string $sid)
 * @method \Twilio\Rest2\Chat\V1\Service\Channel\InviteContext invites(string $sid)
 */
