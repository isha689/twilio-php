...
use Twilio\Rest2\Messaging\V1\BrandRegistration\BrandVettingList;


/**
 * @property BrandVettingList $brandVettings
 * @method \Twilio\Rest2\Messaging\V1\BrandRegistration\BrandVettingContext brandVettings(string $brandVettingSid)
 */
