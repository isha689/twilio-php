...
use Twilio\Rest2\Preview\Understand\Assistant\FieldType\FieldValueList;


/**
 * @property FieldValueList $fieldValues
 * @method \Twilio\Rest2\Preview\Understand\Assistant\FieldType\FieldValueContext fieldValues(string $sid)
 */
