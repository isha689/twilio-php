...
namespace Twilio\Rest2\Preview\Understand;
...
use Twilio\Rest2\Preview\Understand\Assistant\FieldTypeList;
use Twilio\Rest2\Preview\Understand\Assistant\QueryList;
use Twilio\Rest2\Preview\Understand\Assistant\TaskList;
use Twilio\Rest2\Preview\Understand\Assistant\ModelBuildList;
use Twilio\Rest2\Preview\Understand\Assistant\AssistantFallbackActionsList;
use Twilio\Rest2\Preview\Understand\Assistant\AssistantInitiationActionsList;
use Twilio\Rest2\Preview\Understand\Assistant\StyleSheetList;
use Twilio\Rest2\Preview\Understand\Assistant\DialogueList;
 ...
 * @method \Twilio\Rest2\Preview\Understand\Assistant\FieldTypeContext fieldTypes(string $sid)
 * @method \Twilio\Rest2\Preview\Understand\Assistant\AssistantFallbackActionsContext assistantFallbackActions()
 * @method \Twilio\Rest2\Preview\Understand\Assistant\TaskContext tasks(string $sid)
 * @method \Twilio\Rest2\Preview\Understand\Assistant\DialogueContext dialogues(string $sid)
 * @method \Twilio\Rest2\Preview\Understand\Assistant\AssistantInitiationActionsContext assistantInitiationActions()
 * @method \Twilio\Rest2\Preview\Understand\Assistant\ModelBuildContext modelBuilds(string $sid)
 * @method \Twilio\Rest2\Preview\Understand\Assistant\StyleSheetContext styleSheet()
 * @method \Twilio\Rest2\Preview\Understand\Assistant\QueryContext queries(string $sid)
 */
