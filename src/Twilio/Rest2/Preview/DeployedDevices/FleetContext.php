...
namespace Twilio\Rest2\Preview\DeployedDevices;
...
use Twilio\Rest2\Preview\DeployedDevices\Fleet\CertificateList;
use Twilio\Rest2\Preview\DeployedDevices\Fleet\DeviceList;
use Twilio\Rest2\Preview\DeployedDevices\Fleet\KeyList;
use Twilio\Rest2\Preview\DeployedDevices\Fleet\DeploymentList;
 ...
 * @method \Twilio\Rest2\Preview\DeployedDevices\Fleet\DeviceContext devices(string $sid)
 * @method \Twilio\Rest2\Preview\DeployedDevices\Fleet\KeyContext keys(string $sid)
 * @method \Twilio\Rest2\Preview\DeployedDevices\Fleet\DeploymentContext deployments(string $sid)
 * @method \Twilio\Rest2\Preview\DeployedDevices\Fleet\CertificateContext certificates(string $sid)
 */
