 ...
 * @method \Twilio\Rest2\Preview\Sync\Service\SyncListContext syncLists(string $sid)
 * @method \Twilio\Rest2\Preview\Sync\Service\SyncMapContext syncMaps(string $sid)
 * @method \Twilio\Rest2\Preview\Sync\Service\DocumentContext documents(string $sid)
 */
