...
namespace Twilio\Rest2\Preview\Sync\Service;

use Twilio\Exceptions\TwilioException;
use Twilio\ListResource;
use Twilio\Version;
use Twilio\InstanceContext;
use Twilio\Rest2\Preview\Sync\Service\SyncList\SyncListPermissionList;
use Twilio\Rest2\Preview\Sync\Service\SyncList\SyncListItemList;


/**
 * @property SyncListPermissionList $syncListPermissions
 * @property SyncListItemList $syncListItems
 * @method \Twilio\Rest2\Preview\Sync\Service\SyncList\SyncListPermissionContext syncListPermissions(string $identity)
 * @method \Twilio\Rest2\Preview\Sync\Service\SyncList\SyncListItemContext syncListItems(string $index)
 */
