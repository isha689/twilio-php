...
use Twilio\Rest2\Voice\V1\ConnectionPolicy\ConnectionPolicyTargetList;


/**
 * @property ConnectionPolicyTargetList $targets
 * @method \Twilio\Rest2\Voice\V1\ConnectionPolicy\ConnectionPolicyTargetContext targets(string $sid)
 */
