...
namespace Twilio\Rest2\Voice\V1\ConnectionPolicy;
...
class ConnectionPolicyTargetPage extends Page {
     ...
     * @return ConnectionPolicyTargetInstance \Twilio\Rest2\Voice\V1\ConnectionPolicy\ConnectionPolicyTargetInstance
     */
